...
Object.defineProperty(Thing.prototype, "validationMessages", {
    ...
    get: function(){
        ...
        this.properties.forEach(function(property){
            validationMessages = self.definitions[property].validationMessages;
...
Thing.prototype.unset = function unset(propertyName){
    this.definitions[propertyName].value = undefined;
    return this;
};
...
Thing.prototype.mixIn = function(thing, groups){
    ...
    if (thing instanceof Thing){
        thing.properties.forEach(function(propertyName){
            if (groups){
                self.define(groups, thing.definitions[propertyName]);
            } else {
                self.define(thing.definitions[propertyName]);
            }
        });
    } else {

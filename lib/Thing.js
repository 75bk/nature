...
@type Object
*/
Object.defineProperty(Thing.prototype, "_definitionList", { enumerable: false, get: getDefinitions });
...
Thing.prototype.mixIn = function(thing, groups){
    if (thing instanceof Thing){
        for (var property in thing._definitionList){
            if (groups){
                this.define(groups, thing._definitionList[property]);
            } else {
                this.define(thing._definitionList[property]);
            }
        }
    } else {

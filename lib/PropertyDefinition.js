...
function PropertyDefinition(properties){
    var self = this,
        ...
        _valueTest = wodge.arrayify(properties.valueTest),
            ...
            if(valueTest instanceof RegExp){
                ...
                */
                ...
                try{
                    ...
                    return valueTest.call(extras, _value);
                } catch(e){
    ...
    function validate(){
        ...
        if (_validationMessages.length){
            isValid = false;
            addValidationMessage(self.invalidMsg);
    ...
    */
    Object.defineProperty(this, "valueTest", {
        ...
        set: function(newValue){
            _valueTest = wodge.arrayify(newValue);
            validate();
        }
    });

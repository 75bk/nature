...
* All Things can be instantiated with data from the command line, environment, an object literal or file. 
* Once classified, Things can be re-used over and over again

...
/**
 a library for passing consitent, reliable config within and between applications
 @class Config
...
function Config(){
    ...
    /**
     ...
     @chainable
    */
    this.group = function(groupName, optionArray){
        var self = this;
    ...
    */
    this.unset = function unset(optionName){
